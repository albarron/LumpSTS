...
#L1=ar
#L2=ar
#java -cp $JAR:$DEPENDENCIES $CLAZZ -f $INPUT_PATH/STS2017.eval/STS.input.track1.$L1-$L2.txt -o $INPUT_PATH/STS2017.eval/sim/track1.$L1-$L2.0 -l $L1

#L1=en
#L2=en
#java -cp $JAR:$DEPENDENCIES $CLAZZ -f $INPUT_PATH/STS2017.eval/STS.input.track5.$L1-$L2.txt -o $INPUT_PATH/STS2017.eval/sim/track5.$L1-$L2.0 -l $L1

#L1=es
#L2=es
#java -cp $JAR:$DEPENDENCIES $CLAZZ -f $INPUT_PATH/STS2017.eval/STS.input.track3.$L1-$L2.txt -o $INPUT_PATH/STS2017.eval/sim/track3.$L1-$L2.0 -l $L1
...
#L1=en
#L2=en
#java -cp $JAR:$DEPENDENCIES $CLAZZ -f $INPUT_PATH/$L1.test.1_fold/$L1.input.0.txt -o $INPUT_PATH/$L1.test.1_fold/sim/$L1-$L2.0 -l $L1 
